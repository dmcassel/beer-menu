...
Verified against real dev-DB data — beers _Golden Monkey_ (Victory Brewing) and _Gordon Strong's Burton Ale_ (Cassel Brewing); wines _Sauvignon Blanc_ (Kim Crawford) and _Sylvan Riesling_ (Fox Run Winery):
